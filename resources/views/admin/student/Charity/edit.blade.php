        ...
        <div class="col-md-8 p-2 rounded bg-light">
            ...
            <form action="{{ url('update-charity-student/' . $charityStudents->id) }}" method="POST" accept-charset="UTF-8">
                ...
                <div class="input-group mb-3">
                    ...
                    <input type="text" name="firstname" class="form-control" value="{{ $charityStudents->firstname }}"
                        required>
                </div>
                ...
                <div class="input-group mb-3">
                    ...
                    <input type="text" name="middlename" class="form-control" value="{{ $charityStudents->middlename }}"
                        required>
                </div>
                ...
                <div class="input-group mb-3">
                    ...
                    <input type="text" name="year_section" class="form-control"
                        value="{{ $charityStudents->year_section }}" required>
                </div>
                ...
                <div class="input-group mb-3">
                    ...
                    <input type="text" name="parent_name" class="form-control"
                        value="{{ $charityStudents->parent_name }}" required>
                </div>
                ...
                <div class="input-group mb-3">
                    ...
                    <input type="email" name="parent_email" class="form-control"
                        value="{{ $charityStudents->parent_email }}">
                </div>
                ...
                <div class="input-group mb-3">
                    ...
                    <input type="text" name="parent_num" class="form-control"
                        value="{{ $charityStudents->parent_num }}">
                </div>

                <div class="input-group mb-3">
                    <label for="" style="color:dimgray;"><span class=" input-group-text bg-secondary"
                            style="width: 43px;">Ad</span></label>
                    <input type="text" name="address" class="form-control" value="{{ $charityStudents->address }}"
                        required>
                </div>
