        ...
        <div class="card">
            <div class="card-header text-center">
                ...
                <div class="d-flex justify-content-end">
                    <a href="{{ url('show-student-wisdom/' . $student_wis->id . '/parent_conference_record_wisdom/create/') }}"
                    ...
                    <tbody>
                        @forelse ($parent_conference_record_wisdom as $parent_confer_wis)
                            <tr>
                                ...
                                <td><a href="{{ url('/show-student-wisdom/'.$parent_confer_wis->student->id.'/parent_conference_record_wisdom/' . $parent_confer_wis->id) }}"
                                        class="btn btn-xs "><i class="fas fa-search text-info"></i></a></td>
                                <td><a href="{{ url('delete_parent_conference_record_wisdom/' . $parent_confer_wis->id) }}"
