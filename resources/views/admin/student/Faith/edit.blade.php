...
<div class="row d-flex justify-content-center text-dark">
    ...
    @endif
        ...
        <h1 style="text-align:center; color:whitesmoke; margin:auto; font-family:'Segoe UI', Tahoma, Geneva, Verdana, sans-serif; font-size: 20px; color:dimgray;">Name: {{$faithStudents->firstname}} {{$faithStudents->lastname}}</h1>
      ...
      <div class="input-group mb-3 mt-4">
                    ...
                    <input type="text" name="school_id" class="form-control" value="{{ $faithStudents->school_id }}"
                        required>
                </div>
    ...
    <div class="input-group mb-3">
       ...
       <div class="input-group mb-3">
        ...
        <input type="text" name="parent_num" class="form-control"
            value="{{ $faithStudents->parent_num }}">
    </div>
