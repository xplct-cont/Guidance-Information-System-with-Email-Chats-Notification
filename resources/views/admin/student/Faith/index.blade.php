        ...
        <div class="mx-auto" style="width:340px;">
            <form action="{{ route('faith-list') }}" method="GET" role="search">
                ...
                <div class="input-group">
                    ...
                    <input type="text" class="form-control mr-2" name="faith" placeholder="Search" id="faith">
                        ...
                        <div class="card-body">
                            <div class="" style="position: relative; top:-20px;">
                                <a class="btn btn-secondary mt-2 ml-2 mr-2" style=""
                                    href="{{ route('export_faithStudents_pdf') }}"><span class="fas fa-file-pdf text-danger"
                                        style="font-size: 15px;"></span> PDF</a>
                                <a href="/export_faithStudents_excel" class=" mt-2 ml-2 btn btn-secondary"><span
                                        ...
                                        @forelse ($faithStudents as $faith)
                                            <tr class="text-center">
                                                ...
                                                <td class="d-none d-md-table-cell d-lg-table-cell d-xl-table-cell"
                                                    style="text-align: center">{{ $faith->school_id }}</td>
                                                <td>{{ $faith->lastname }}</td>
                                                <td class="d-none d-md-table-cell d-lg-table-cell d-xl-table-cell"
                                                    style="text-align: center">{{ $faith->firstname }}</td>
                                                <td class="d-none d-md-table-cell d-lg-table-cell d-xl-table-cell"
                                                    style="text-align: center">{{ $faith->middlename }}</td>
                                                <td class="d-none d-md-table-cell d-lg-table-cell d-xl-table-cell"
                                                    style="text-align: center">{{ $faith->year_section }}</td>
                                                <td class="d-none d-md-table-cell d-lg-table-cell d-xl-table-cell"
                                                    style="text-align: center">{{ $faith->gender }}</td>
                                                <td class="d-none d-md-table-cell d-lg-table-cell d-xl-table-cell"
                                                    style="text-align: center">{{ $faith->email }}</td>
                                                <td class="d-none d-md-table-cell d-lg-table-cell d-xl-table-cell"
                                                    style="text-align: center">{{ $faith->parent_num }}</td>
                                                <td class="d-none d-md-table-cell d-lg-table-cell d-xl-table-cell"
