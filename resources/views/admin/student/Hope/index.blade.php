                        ...
                        <div class="card-body">
                            <div class="" style="position: relative; top:-20px;">
                                <a class="btn btn-secondary mt-2 ml-2 mr-2" style=""
                                    href="{{ route('export_hopeStudents_pdf') }}"><span class="fas fa-file-pdf text-danger"
                                        style="font-size: 15px;"></span> PDF</a>
                                <a href="/export_hopeStudents_excel" class=" mt-2 ml-2 btn btn-secondary"><span
                                        class="fas fa-file-excel text-success" style="font-size: 15px;"></span> Excel</a>

                                <div class="d-flex justify-content-end">
                                    <p class="text-dark">Number of students : {{ $hope }}</p>
                                </div>
                                    ...
                                    <tbody>
                                        @forelse ($hopeStudents as $hope)
                                            <tr class="text-center">
                                                ...
                                                <td class="d-none d-md-table-cell d-lg-table-cell d-xl-table-cell"
                                                    style="text-align: center">{{ $hope->middlename }}</td>
                                                <td class="d-none d-md-table-cell d-lg-table-cell d-xl-table-cell"
                                                    style="text-align: center">{{ $hope->year_section }}</td>
                                                <td class="d-none d-md-table-cell d-lg-table-cell d-xl-table-cell"
                                                    style="text-align: center">{{ $hope->gender }}</td>
                                                <td class="d-none d-md-table-cell d-lg-table-cell d-xl-table-cell"
                                                    style="text-align: center">{{ $hope->email }}</td>
                                                <td class="d-none d-md-table-cell d-lg-table-cell d-xl-table-cell"
                                                    style="text-align: center">{{ $hope->parent_num }}</td>
                                                <td class="d-none d-md-table-cell d-lg-table-cell d-xl-table-cell"
