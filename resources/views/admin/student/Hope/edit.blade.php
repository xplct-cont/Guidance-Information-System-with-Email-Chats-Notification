...
<div class="row d-flex justify-content-center text-dark">
    ...
    @endif
        ...
        <h1 style="position: absolute; left:32%; color:whitesmoke; margin:auto; font-family:'Segoe UI', Tahoma, Geneva, Verdana, sans-serif; font-size: 20px; color:dimgray;">{{$hopeStudents->firstname}} {{$hopeStudents->lastname}}</h1>
        ...
        <form action="{{url('update-hope-student/'.$hopeStudents->id)}}" method="POST" accept-charset="UTF-8" >
            ...
            <div class="input-group mb-3 mt-4">
                ...
                <input type="text" name="school_id" class="form-control" value="{{ $hopeStudents->school_id }}"
                    required>
            </div>
