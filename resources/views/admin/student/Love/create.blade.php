    ...
    <div class="row d-flex justify-content-center text-dark">
        <div class="col-md-11 elevation-1 p-3 rounded bg-light">
            ...
            <div class="container mb-0">
                <form action="{{ url('/add-new-love-student') }}" method="POST">
                    @csrf
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="year_section" class="form-control" value="Grade 12 - Love"
                                    readonly>
