...
<div class="row d-flex justify-content-center text-dark">
    ...
    @endif
        ...
        <h1 style="text-align:center; color:whitesmoke; margin:auto; font-family:'Segoe UI', Tahoma, Geneva, Verdana, sans-serif; font-size: 20px; color:dimgray;">Name: {{$loveStudents->firstname}} {{$loveStudents->lastname}}</h1>
