...
<div class="row d-flex justify-content-center text-dark">
    ...
    @endif
        ...
        <h1 style="position: absolute; left:32%; color:whitesmoke; margin:auto; font-family:'Segoe UI', Tahoma, Geneva, Verdana, sans-serif; font-size: 20px; color:dimgray;"> {{$loveStudents->firstname}} {{$loveStudents->lastname}}</h1>
        ...
        <form action="{{url('update-love-student/'.$loveStudents->id)}}" method="POST" accept-charset="UTF-8" >
            ...
            <div class="input-group mb-3 mt-4">
                ...
                <input type="text" name="school_id" class="form-control" value="{{ $loveStudents->school_id }}"
                    required>
            </div>
    ...
    <div class="input-group mb-3">
       ...
       <div class="input-group mb-3">
        ...
        <input type="text" name="middlename"  class="form-control" value="{{$loveStudents->middlename}}" required>
        </div>
       ...
       <div class="input-group mb-3">
        ...
        <input type="text" name="age" class="form-control" value="{{ $loveStudents->age }}" required>
    </div>

       <div class="input-group mb-3">
       <label for="" style="color:dimgray;"><span class="fas fa-envelope input-group-text bg-secondary" style="width: 43px;"></span></label>
        <input type="email" name="email" class="form-control" value="{{$loveStudents->email}}" required>
    </div>

    <div class="input-group mb-3">
        <label for="" style="color:dimgray;"><span class=" input-group-text bg-secondary" style="width: 43px;">Pn</span></label>
         <input type="text" name="parent_name" class="form-control" value="{{$loveStudents->parent_name}}" required>
     </div>

     <div class="input-group mb-3">
        <label for="" style="color:dimgray;"><span class="fas fa-envelope input-group-text bg-secondary" style="width: 43px;"></span></label>
         <input type="email" name="parent_email" class="form-control" value="{{$loveStudents->parent_email}}">
     </div>
        ...
        <div class="form-group text-dark d-flex justify-content-center">
            <div class="maxl">
                <label class="radio inline mr-5">
                    <input type="radio" name="gender" value="Male" {{ ($loveStudents->gender == 'Male' ? ' checked' : 'Unchecked') }}>
                    <span>Male</span>
                </label>
                <label class="radio inline">
                    <input type="radio" name="gender" value="Female"  {{ ($loveStudents->gender == 'Female' ? ' checked' : 'Unchecked') }}>
                    <span>Female</span>
                </label>
            </div>
        </div>
