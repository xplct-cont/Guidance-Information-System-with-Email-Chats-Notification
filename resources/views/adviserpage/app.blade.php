...
<div class="wrapper">
    ...
    <!-- Main Header -->
     <nav class="main-header navbar navbar-expand navbar-info elevation-0">
        ...
        <ul class="navbar-nav">
            <li class="nav-item">
                <a class="nav-link" data-widget="pushmenu" href="#" role="button"><i class="fas fa-bars text-light"></i><h2 style="position:relative; margin:auto; left:23px; top:-21.2px; font-size:15px; color:white;">
        ...
        <footer class="sticky-footer">
            <div class="container">
                <div class="copyright text-center">
                    <span style="color: whitesmoke;">&copy; Pangangan National High School 2022</span>
                </div>
            </div>
        </footer>
       </div>
